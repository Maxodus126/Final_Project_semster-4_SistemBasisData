...
const accounts = {
  Mahasiswa: { username: 'mahasiswa', password: 'mhs123', name: 'Aflin Awaludin', code: '24360007', role: 'Mahasiswa', avatar: 'AA' },
...
const seedStudents = [
  ...
  { nim: '24360002', name: 'Putri Nurhaliza', prodi: 'Teknik Informatika', semester: 2, ipk: 3.82, attendance: 95, risk: 'Rendah', status: 'Aktif' },
  { nim: '24364001', name: 'Dosma Silitonga', prodi: 'Teknik Informatika', semester: 2, ipk: 3.41, attendance: 84, risk: 'Sedang', status: 'Aktif' },
  { nim: '24360005', name: 'Fathurahman Al Faqih', prodi: 'Teknik Informatika', semester: 2, ipk: 3.56, attendance: 88, risk: 'Rendah', status: 'Aktif' },
  { nim: '24360004', name: 'Fadil Ardiansyah', prodi: 'Teknik Informatika', semester: 2, ipk: 3.36, attendance: 78, risk: 'Sedang', status: 'Aktif' },
  { nim: '24360008', name: 'Dito Bima Ramadhan', prodi: 'Teknik Informatika', semester: 2, ipk: 3.22, attendance: 74, risk: 'Tinggi', status: 'Aktif' },
  { nim: '24360006', name: 'Nabila Latifatul Hamdah', prodi: 'Teknik Informatika', semester: 2, ipk: 3.91, attendance: 97, risk: 'Rendah', status: 'Aktif' },
  { nim: '24360003', name: 'Raffli Islami Fashya', prodi: 'Teknik Informatika', semester: 2, ipk: 3.49, attendance: 86, risk: 'Sedang', status: 'Aktif' },
  { nim: '24360009', name: 'Adriano Michael Silaen', prodi: 'Teknik Informatika', semester: 2, ipk: 3.67, attendance: 90, risk: 'Rendah', status: 'Aktif' },
  { nim: '24360007', name: 'Aflin Awaludin', prodi: 'Teknik Informatika', semester: 2, ipk: 3.88, attendance: 94, risk: 'Rendah', status: 'Aktif' }
];
...
function commandItems() {
  ...
  if (typeof buildCommandItems === 'function') return buildCommandItems();
...
/* =========================================================
   ISTN ONE PORTAL V14 SIAKAD QUANTUM — SYSTEM OVERRIDES
   ========================================================= */
function renderPage(page) {
...
try {
  document.title = 'ISTN One Portal V16 All Accounts Elite';
...
/* =========================================================
   ISTN ONE PORTAL V16 ALL ACCOUNTS ELITE — ACCOUNT OVERRIDES
   ========================================================= */
...
function quickCredentials(role) {
  $('#roleSelect').value = role;
  if (role === 'Mahasiswa') { $('#username').value = '24360007'; $('#password').value = '24360007'; return; }
...
try {
  ...
  if (badge) badge.innerHTML = '<i></i> V16 ALL ACCOUNTS ELITE';
} catch (_) {}
...
function renderBlueprintBuilder() {
  $('#content').innerHTML = pageShell('Blueprint Builder 7 Layer', 'Arsitektur SC-DATA siap AI yang terhubung dengan web akademik.', `<button class="small-btn" data-page="database-proof">Lihat Database Proof</button>`, `
    <section class="grid grid-3">
      ...
      ${blueprintCard('6. Serving Apps','ISTN One Portal, Event Monitor, Pipeline Builder, Search/RAG, Database Proof')}
